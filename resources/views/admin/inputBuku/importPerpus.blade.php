@extends('layout.app')
@section('title', 'Import Buku Perpustakaan')
            ...
            <div class="card shadow-sm border-0 rounded-3">
                <div class="card-header bg-white border-bottom py-3">
                    <h5 class="card-title mb-0 fw-bold text-info">
                        <i class="bi bi-file-earmark-arrow-up me-2"></i>Import Buku Perpustakaan via CSV
                    </h5>
                </div>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="alert alert-info border-0 bg-light text-dark mb-4">
                        ...
                        <div class="bg-white p-2 rounded border font-monospace small text-muted overflow-auto" style="white-space: nowrap;">
                            title, author, publisher, publication_year, category, summary, isbn, stock, status
                        </div>
                    ...
                    <form action="{{ route('admin.books.library.import.process') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-4">
                            <label for="csv_file" class="form-label fw-semibold text-secondary">Pilih File CSV/Excel Buku Perpustakaan</label>
